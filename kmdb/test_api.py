...
class TestCommentReviewView(TestCase):
    ...
    def test_user_can_create_comment(self):
        ...
        comment = self.client.post("/api/movies/1/comments/",
                                   self.comment_data,
                                   format="json")
        ...
        self.assertDictEqual(movies.json()[0]["comment_set"][0],
                             self.output_format_data)
    ...
    def test_admin_or_critic_cannot_create_comment(self):
        ...
        status_code = self.client.post("/api/movies/1/comments/",
                                       self.movie_data,
                                       format="json").status_code
    ...
    def test_create_comment_with_invalid_movie_id(self):
        ...
        comment = self.client.post("/api/movies/99/comments/",
                                   self.comment_data,
                                   format="json")
    ...
    def test_user_can_change_a_comment_on_the_movie(self):
        ...
        comment = self.client.put("/api/movies/1/comments/",
                                  comment_change,
                                  format="json")

        # get movies
        movies = self.client.get("/api/movies/", format="json").json()
        self.assertEqual(movies[0]["comment_set"][0]["comment"],
                         "fera demais!")

    def test_user_cannot_change_a_comment_on_the_movie_that_did_not_comment(
            self):
        # create admin user
        self.client.post("/api/accounts/", self.admin_data, format="json")
        ...
        # user comment
        self.client.post("/api/movies/1/comments/",
                         self.comment_data,
                         format="json")
        ...
        comment = self.client.put("/api/movies/99/comments/",
                                  comment_change,
                                  format="json")
...
class TestAccountView(TestCase):
    ...
    def test_create_and_login_for_user_account(self):
        client = APIClient()
        # create user
        user = client.post("/api/accounts/", self.user_data,
                           format="json").json()
    ...
    def test_create_and_login_for_critic_account(self):
        client = APIClient()
        # create user
        user = client.post("/api/accounts/", self.critic_data,
                           format="json").json()
    ...
    def test_create_and_login_for_admin_account(self):
        client = APIClient()
        # create user
        user = client.post("/api/accounts/", self.admin_data,
                           format="json").json()
...
class TestCriticismReviewView(TestCase):
    def setUp(self):
        ...
        self.review_data_2 = {
            "stars": 10,
            "review":
            "Ótimo filme. Adorei a parte em que o fulaninho resgatou a fulaninha",
            "spoilers": True,
        }
    ...
    def test_create_review(self):
        ...
        response = client.post("/api/movies/1/review/",
                               self.review_data_1,
                               format="json")
        ...
        token = client.post("/api/login/", self.user_login_data,
                            format="json").json()["token"]
        client.credentials(HTTP_AUTHORIZATION="Token " + token)
        ...
        response = client.post("/api/movies/2/review/",
                               self.wrong_review_data,
                               format="json")
        self.assertEqual(response.status_code, 400)
    ...
    def test_update_review(self):
        ...
        response = client.put("/api/movies/1/review/",
                              self.review_data_2,
                              format="json")
        expected_review_response = {
            "id": 1,
        ...
        response = client.put("/api/movies/2/review/",
                              self.review_data_2,
                              format="json")
        self.assertEqual(response.status_code, 404)

        # critic user trying to update review when movie doesnt exists
        response = client.put("/api/movies/3/review/",
                              self.review_data_2,
                              format="json")
        self.assertEqual(response.status_code, 404)
